...
Based on ipython-website/_scripts/gh-pages.py
...
pages_repo = 'http://bitbucket.org/iep-ide/iep-ide.bitbucket.org'
...
def sh3(cmd):
    ...
    if retcode:
        ...
        return out.rstrip().decode('utf-8', 'ignore'), err.rstrip().decode('utf-8', 'ignore')
