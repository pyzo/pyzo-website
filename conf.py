...
# FTP info for "make ftpupload"
ftp_address = 'ftp.d1190685.cp.blacknight.com'
ftp_dir = '/webspace/httpdocs/pyzo.tld/'
...
sys.path.insert(0, os.path.abspath('../pyzo-website/scripts'))
...
html_theme_path = ['../pyzo-website/themes']

# The name for this set of Sphinx documents.  If None, it defaults to
# "<project> v<release> documentation".
html_title = 'Pyzo - Python to the people'
...
# of the sidebar.
html_logo = '_static/pyzologo96w.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/pyzologo.ico'
...
latex_documents = [
  ('index', 'Pyzo.tex', 'Pyzo Documentation',
   'Almar Klein, Rob Reilink, Ludo Visser', 'manual'),
]
...
man_pages = [
    ('index', 'pyzo', 'Pyzo Documentation',
     ['Almar Klein, Rob Reilink, Ludo Visser'], 1)
]
...
texinfo_documents = [
  ('index', 'Pyzo', 'Pyzo Documentation',
   'Almar Klein, Rob Reilink, Ludo Visser', 'Pyzo', 'One line description of project.',
   'Miscellaneous'),
]
