...
* Windows:
  [Pyzo installer](https://github.com/pyzo/pyzo/releases/download/v4.12.4/pyzo-4.12.4-win64.exe)
  (64bit). If your AntiVirus complaints, [read this](https://github.com/pyzo/pyzo/issues/800).
* MacOS:
  [Pyzo dmg](https://github.com/pyzo/pyzo/releases/download/v4.12.4/pyzo-4.12.4-macos_x86_64.dmg).
  If you get a warning about Apple being unable to check the file, you must right-click-open the file.
* Linux:
  [Pyzo tarball](https://github.com/pyzo/pyzo/releases/download/v4.12.4/pyzo-4.12.4-linux_x86_64.tar.gz)
