...
* Windows:
  [Pyzo installer](https://github.com/pyzo/pyzo/releases/download/v4.11.4/pyzo-4.11.4-win64.exe)
  (64bit)
* macOS:
  [Pyzo dmg](https://github.com/pyzo/pyzo/releases/download/v4.11.4/pyzo-4.11.4-macos.dmg)
