...
* Windows:
    * Download the [pyzo installer](https://github.com/pyzo/pyzo/releases/download/v4.18.0/pyzo-4.18.0-win64.exe).
...
* MacOS:
    * Download [Pyzo dmg for Apple Silicon (arm64)](https://github.com/pyzo/pyzo/releases/download/v4.18.0/pyzo-4.18.0-macos_arm64.dmg)
      or [Pyzo dmg for Intel (x86_64)](https://github.com/pyzo/pyzo/releases/download/v4.18.0/pyzo-4.18.0-macos_x86_64.dmg).
...
* Linux:
    * [Download Pyzo tarball](https://github.com/pyzo/pyzo/releases/download/v4.18.0/pyzo-4.18.0-linux_x86_64.tar.gz).
